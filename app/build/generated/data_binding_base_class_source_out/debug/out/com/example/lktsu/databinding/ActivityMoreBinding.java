...
public final class ActivityMoreBinding implements ViewBinding {
  ...
  private ActivityMoreBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textViewMore) {
  ...
  public static ActivityMoreBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textViewMore;
      TextView textViewMore = rootView.findViewById(id);
      if (textViewMore == null) {
        break missingId;
      }

      return new ActivityMoreBinding((ConstraintLayout) rootView, textViewMore);
    }
